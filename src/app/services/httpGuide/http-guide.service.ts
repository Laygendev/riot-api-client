...
export class HttpGuideService {
	...
	public get(args?: any): Observable<any> {
		let url: string = "https://server.guideslol.com/guide/";
		...
		if ( args && args._id ) {
			url = "https://server.guideslol.com/guide/" + args._id;
		}
		...
		if ( ! args ) {
			url = "https://server.guideslol.com/guides";
		}
	...
	public getByAuthorId(authorId: string): Observable<any> {
		let url: string = "https://server.guideslol.com/guide/author/" + authorId;

		return this.httpClient.get( url, {responseType: 'json'} );
	}

	public getFavorite(args?: any): Observable<any> {
		let url: string = "https://server.guideslol.com/guide-favorite/";
	...
	public vote(guideId: string, userId: string): Observable<any> {
		let url: string = "https://server.guideslol.com/vote/";
