...
export class HttpGuideService {
	...
	public get(args?: any): Observable<any> {
		let url: string = "http://server.guideslol.com:3002/guide/";
		...
		if ( args && args._id ) {
			url = "http://server.guideslol.com:3002/guide/" + args._id;
		}
		...
		if ( ! args ) {
			url = "http://server.guideslol.com:3002/guides";
		}
	...
	public getByAuthorId(authorId: string): Observable<any> {
		let url: string = "http://server.guideslol.com:3002/guide/author/" + authorId;

		return this.httpClient.get( url, {responseType: 'json'} );
	}

	public getFavorite(args?: any): Observable<any> {
		let url: string = "http://server.guideslol.com:3002/guide-favorite/";
	...
	public vote(guideId: string, userId: string): Observable<any> {
		let url: string = "http://server.guideslol.com:3002/vote/";
